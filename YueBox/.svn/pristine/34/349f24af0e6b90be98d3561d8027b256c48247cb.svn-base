...
public abstract class SectionUniversalAdapter extends BaseAdapter implements SectionIndexer, OnScrollListener {
	public static final String TAG = SectionUniversalAdapter.class.getSimpleName();
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		if (view instanceof SectionOrderListView) {
			((SectionOrderListView) view).configureHeaderView(firstVisibleItem);
		}
	}
	 ...
	 * and call {@link SosUniversalListView#tellNoMoreData()} if there is no more pages.
	 * 
